          ...
          <div className="contact-info animate" data-animate="slideInLeft 2s">
            ...
            <ul className="contact-info-list">
              <li className="contact-info-item">
                ...
                <span>Address: Ha Noi City, Vietnam</span>
              </li>
              <li className="contact-info-item">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span className="contact-phone">
                  Phone:
                  <a href="tel:+84366270052"> +84 926 510 209</a>
                </span>
              </li>
              <li className="contact-info-item">
                <svg
                ...
                <span className="contact-email">
                  Email:
                  <a href="mailto:hoanghai121298.dhtl@gmail.com">
                    hoanghai121298.dhtl@gmail.com
                  </a>
                </span>
              </li>
              <li className="contact-info-item">
                ...
                <span>
                  Github:
                  <a href="#home"> https://github.com/itsme9xx</a>
                </span>
              </li>
            </ul>
          </div>
